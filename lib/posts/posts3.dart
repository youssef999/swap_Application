...
class Posts3 extends StatefulWidget {
  @override
  _Posts3 createState() => _Posts3();
}
class _Posts3 extends State<Posts3> {
  String allposts;
            ...
            children: [
              ...
              Flexible(
                ...
                child: Expanded(
                  ...
                  child: StreamBuilder(
                      stream:
                      Firestore.instance.collection('posts5').where("category",isEqualTo:"tec")
