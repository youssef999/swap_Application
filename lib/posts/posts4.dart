...
class Posts4 extends StatefulWidget {
  @override
  _Posts4 createState() => _Posts4();
}

class _Posts4 extends State<Posts4> {
  String allposts;
            ...
            children: [
              ...
              Flexible(
                ...
                child: Expanded(
                  ...
                  child: StreamBuilder(
                      stream:
                      Firestore.instance.collection('posts5').where("category",isEqualTo:"clothes")
