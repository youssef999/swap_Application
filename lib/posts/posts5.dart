...
class Posts5 extends StatefulWidget {
  @override
  _Posts5 createState() => _Posts5();
}

class _Posts5 extends State<Posts5> {
  String allposts;
            ...
            children: [
              ...
              Flexible(
                child: Expanded(
                  child: StreamBuilder(
                      stream:
                      Firestore.instance.collection('posts5').where("category",isEqualTo:"accessories")
