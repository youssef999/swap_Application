...
class Posts6 extends StatefulWidget {
  @override
  _Posts6 createState() => _Posts6();
}

class _Posts6 extends State<Posts6> {
  String allposts;
            ...
            children: [
              ...
              Flexible(
                ...
                child: Expanded(
                  ...
                  child: StreamBuilder(
                      stream:
                      Firestore.instance.collection('posts5').where("category",isEqualTo:"others")
